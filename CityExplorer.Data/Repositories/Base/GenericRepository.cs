namespace CityExplorer.Data.Repositories.Base
{
    ...
    using CityExplorer.Common.Extensions;

    public class GenericRepository<T> : IRepository<T> where T : class
    {
        public GenericRepository(ICityExplorerDbContext context)
        {
            if (context == null)
            {
        ...
        protected ICityExplorerDbContext Context { get; set; }
